...
Original file is located at
    https://colab.research.google.com/drive/1PZpfxJdzCR90FPqa9GM044_pcR---Opc
...
!pip uninstall -y numpy torch torchvision transformers h5py timm einops einops-exts
!pip install --force-reinstall "numpy<2" torch==2.0.1 timm==1.0.3 einops==0.6.1 einops-exts==0.0.4 transformers==4.46.0 h5py==3.8.0
...
!pip install torch==2.0.1 timm==1.0.3 einops==0.6.1 einops-exts==0.0.4 transformers==4.46.0
...
# %cd /content/TITAN/LLaVA

!conda create -n llava python=3.10 -y
!conda activate llava

!pip install flash-attn
!conda install pytorch=2.2.0 cudatoolkit=11.7 -c pytorch
!pip install fastapi
!pip install uvicorn
!pip install gradio
!sudo apt-get update
